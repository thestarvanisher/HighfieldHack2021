...
from HighfieldHack2.apps.core.models import Debate, DebateTextArgument, DebateVote, Poll, PollChoiceVote, PollChoice
...
class DebateTextArgumentAdmin(admin.ModelAdmin):
    ...
    list_display = ("title", "description", "owner", "is_for", "debate", "posted_at")
